...
CONFIG: Dict = {
    ...
    'fuzzer': {
        ...
        'aflsmart': {
            ...
            'crash_dir': CRASH_DIR,
            'skip_crash_file': ['README.txt'],
            'command': '/fuzzer/aflsmart/afl-fuzz',  # fuzzer binary path
            'target_root': '/d/p/justafl',  # which binary is used to fuzz
            'afl_based': True,
        },
        'aflfast': {
    ...
    'target': {
        ...
        'wavpack': {
            'group': 'unibench',
            'seed': '/seeds/unibench/general_evaluation/wav',
            'input_model': '/fuzzer/aflsmart/input_models/wav.xml',
            'dict': '/fuzzer/aflsmart/dictionaries/wav.dict',
            'code_dir': 'unibench/swftools',
            'args': {
                'default': '-y @@ -o out',
            },
            'unsupported': ['libfuzzer', 'angora']
